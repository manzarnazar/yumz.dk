...
import { SelectChangeEvent, OutlinedSelectProps } from "@mui/material"; // Import OutlinedSelectProps
...
interface Props extends OutlinedSelectProps {
  ...
  onChange?: (event: SelectChangeEvent<unknown>, child: React.ReactNode) => void;  // Add onChange to the props
